    ...
    <div className="flex items-center justify-between border p-4 rounded shadow-sm bg-white max-w-xl mb-4">
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className="bg-pink-500 px-3 py-1 text-sm font-medium bg-gray-200 rounded hover:bg-gray-500"
        >
          –
        </button>
        <span className="bg-pink-500 px-3 text-sm font-semibold">{qty}</span>
        <button
